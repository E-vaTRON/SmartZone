...
namespace ControlZone.ViewModels.ViewModelPages.ViewModelDeviceViews
{
    public class ViewModelDeviceList : ViewModelBase
    {
        ...
        private ObservableCollection<DeviceBase> GetDevices()
        {
            ...
            {
                new CommandCenter {Id = 1, Model = "Command Center 1.0", DeviceType = 0, IconImageSource = "CommandCenter.png", Color = "Green", OverallProcess = 0.3f, PowerStatus = true, CPUPercentage = 40.0f },
                new TC {Id = 2, Model = "TC 1.1", DeviceType = 1, IconImageSource = "Trash.png", OverallProcess = 0.7f, PowerStatus = true, CurrentCapacity = 80.0f },
                new TC {Id = 3, Model = "TC 1.1", DeviceType = 1, IconImageSource = "Trash.png", OverallProcess = 0.5f, PowerStatus = false, CurrentCapacity = 80.0f }
            };
        }
